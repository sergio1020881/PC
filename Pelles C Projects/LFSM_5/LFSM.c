...
int FSMmagic(int xi, int xf, int nbits);
...
l.getnum=FSMgetnum;
l.putstr=FSMputstr;
l.readconsole=FSMreadconsole;
l.readint=FSMreadint;
l.read=LOGICread;
l.learn=LOGIClearn;
l.quant=FSMquant;
...
l.diff=FSMdiff;
l.magic=FSMmagic;
l.getnumv2=FSMgetnumv2;
l.strtotok=FSMstrtotok;
...
int keyfound;
int diferenca;
diferenca=r->diff(r->recal,input);
